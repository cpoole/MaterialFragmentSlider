...
//               }));
    ...
    public void  onActivityCreated(Bundle savedInstanceState){
        ...
        switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
            case 0:
                foodEntries = menuManager.getAppetizers();
                break;
            case 1:
                foodEntries = menuManager.getSoupSalad();
                break;
            case 2:
                foodEntries = menuManager.getEntrees();
                break;
            case 3:
                foodEntries = menuManager.getDesserts();
                break;
            case 4:
                foodEntries = menuManager.getALaCarte();
                break;
            case 5:
                foodEntries = menuManager.getBeverages();
                break;
            default:
